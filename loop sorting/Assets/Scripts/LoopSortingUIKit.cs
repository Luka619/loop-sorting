        ...
        private static ConfigFile DefaultConfig()
        {
            ...
            return new ConfigFile
            {
                ...
                sprites = new[]
                {
                    ...
                    new SpriteEntry { key = "ui.icon.sort", path = "conveyor_belt_texture_v02_candy/icon_sort_noframe.png", pixelsPerUnit = 100f, applyNineSlice = false },
                    new SpriteEntry { key = "ui.icon.shuffle", path = "conveyor_belt_texture_v02_candy/icon_shuffle_noframe.png", pixelsPerUnit = 100f, applyNineSlice = false },
