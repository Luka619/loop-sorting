...
## World_Sprites/box_completed_badge_check_256.png (292x304)
- template: GENERIC

**Positive prompt**
~~~
UI element background, creamy plastic toy style, rounded corners, thick outline, soft inner shadow, no text, exact 292x304px, transparent background, centered, no cropping, leave generous transparent padding on all sides (at least ~8% of canvas), ensure the full silhouette and all shadows are fully inside the frame, no element touches the image border, crisp edges, sRGB, PNG, soft 3D plastic UI, creamy warm candy style, rounded corners, thick outline, subtle specular highlight from top-left, soft ambient occlusion, soft inner shadow, gentle drop shadow inside the canvas padding, clean silhouette, fine grain, mobile game UI asset, orthographic front view
~~~
...
## World_Sprites/box_completed_badge_check_512.png (548x560)
- template: GENERIC

**Positive prompt**
~~~
UI element background, creamy plastic toy style, rounded corners, thick outline, soft inner shadow, no text, exact 548x560px, transparent background, centered, no cropping, leave generous transparent padding on all sides (at least ~8% of canvas), ensure the full silhouette and all shadows are fully inside the frame, no element touches the image border, crisp edges, sRGB, PNG, soft 3D plastic UI, creamy warm candy style, rounded corners, thick outline, subtle specular highlight from top-left, soft ambient occlusion, soft inner shadow, gentle drop shadow inside the canvas padding, clean silhouette, fine grain, mobile game UI asset, orthographic front view
~~~
...
## World_Sprites/box_completed_frame_glow_512.png (512x512)
- template: GENERIC

**Positive prompt**
~~~
UI element background, creamy plastic toy style, rounded corners, thick outline, soft inner shadow, no text, exact 512x512px, transparent background, centered, no cropping, leave generous transparent padding on all sides (at least ~8% of canvas), ensure the full silhouette and all shadows are fully inside the frame, no element touches the image border, crisp edges, sRGB, PNG, soft 3D plastic UI, creamy warm candy style, rounded corners, thick outline, subtle specular highlight from top-left, soft ambient occlusion, soft inner shadow, gentle drop shadow inside the canvas padding, clean silhouette, fine grain, mobile game UI asset, orthographic front view
~~~
...
## World_Sprites/box_completed_glass_overlay_512.png (512x512)
- template: GENERIC
...
## World_Sprites/box_outline_dashed_open_right.png (552x562)
- template: GENERIC

**Positive prompt**
~~~
UI element background, creamy plastic toy style, rounded corners, thick outline, soft inner shadow, no text, exact 552x562px, transparent background, centered, no cropping, leave generous transparent padding on all sides (at least ~8% of canvas), ensure the full silhouette and all shadows are fully inside the frame, no element touches the image border, crisp edges, sRGB, PNG, soft 3D plastic UI, creamy warm candy style, rounded corners, thick outline, subtle specular highlight from top-left, soft ambient occlusion, soft inner shadow, gentle drop shadow inside the canvas padding, clean silhouette, fine grain, mobile game UI asset, orthographic front view
~~~
...
## World_Sprites/box_outline_dashed_open_top.png (552x562)
- template: GENERIC
...
## World_Sprites/completed_overlay.png (520x520)
- template: GENERIC

**Positive prompt**
~~~
UI element background, creamy plastic toy style, rounded corners, thick outline, soft inner shadow, no text, exact 520x520px, transparent background, centered, no cropping, leave generous transparent padding on all sides (at least ~8% of canvas), ensure the full silhouette and all shadows are fully inside the frame, no element touches the image border, crisp edges, sRGB, PNG, soft 3D plastic UI, creamy warm candy style, rounded corners, thick outline, subtle specular highlight from top-left, soft ambient occlusion, soft inner shadow, gentle drop shadow inside the canvas padding, clean silhouette, fine grain, mobile game UI asset, orthographic front view
~~~
...
## World_Sprites/conveyor_slot.png (252x162)
- template: GENERIC

**Positive prompt**
~~~
UI element background, creamy plastic toy style, rounded corners, thick outline, soft inner shadow, no text, exact 252x162px, transparent background, centered, no cropping, leave generous transparent padding on all sides (at least ~8% of canvas), ensure the full silhouette and all shadows are fully inside the frame, no element touches the image border, crisp edges, sRGB, PNG, soft 3D plastic UI, creamy warm candy style, rounded corners, thick outline, subtle specular highlight from top-left, soft ambient occlusion, soft inner shadow, gentle drop shadow inside the canvas padding, clean silhouette, fine grain, mobile game UI asset, orthographic front view
~~~
...
## World_Sprites/lock_marker_color_disc.png (160x160)
- template: GENERIC

**Positive prompt**
~~~
UI element background, creamy plastic toy style, rounded corners, thick outline, soft inner shadow, no text, exact 160x160px, transparent background, centered, no cropping, leave generous transparent padding on all sides (at least ~8% of canvas), ensure the full silhouette and all shadows are fully inside the frame, no element touches the image border, crisp edges, sRGB, PNG, soft 3D plastic UI, creamy warm candy style, rounded corners, thick outline, subtle specular highlight from top-left, soft ambient occlusion, soft inner shadow, gentle drop shadow inside the canvas padding, clean silhouette, fine grain, mobile game UI asset, orthographic front view
~~~
...
## World_Sprites/lock_marker_lock_icon.png (192x202)
- template: GENERIC

**Positive prompt**
~~~
UI element background, creamy plastic toy style, rounded corners, thick outline, soft inner shadow, no text, exact 192x202px, transparent background, centered, no cropping, leave generous transparent padding on all sides (at least ~8% of canvas), ensure the full silhouette and all shadows are fully inside the frame, no element touches the image border, crisp edges, sRGB, PNG, soft 3D plastic UI, creamy warm candy style, rounded corners, thick outline, subtle specular highlight from top-left, soft ambient occlusion, soft inner shadow, gentle drop shadow inside the canvas padding, clean silhouette, fine grain, mobile game UI asset, orthographic front view
~~~
...
## World_Sprites/lock_marker_plate.png (296x308)
- template: GENERIC

**Positive prompt**
~~~
UI element background, creamy plastic toy style, rounded corners, thick outline, soft inner shadow, no text, exact 296x308px, transparent background, centered, no cropping, leave generous transparent padding on all sides (at least ~8% of canvas), ensure the full silhouette and all shadows are fully inside the frame, no element touches the image border, crisp edges, sRGB, PNG, soft 3D plastic UI, creamy warm candy style, rounded corners, thick outline, subtle specular highlight from top-left, soft ambient occlusion, soft inner shadow, gentle drop shadow inside the canvas padding, clean silhouette, fine grain, mobile game UI asset, orthographic front view
~~~
...
## World_Sprites/lock_overlay.png (556x568)
- template: GENERIC

**Positive prompt**
~~~
UI element background, creamy plastic toy style, rounded corners, thick outline, soft inner shadow, no text, exact 556x568px, transparent background, centered, no cropping, leave generous transparent padding on all sides (at least ~8% of canvas), ensure the full silhouette and all shadows are fully inside the frame, no element touches the image border, crisp edges, sRGB, PNG, soft 3D plastic UI, creamy warm candy style, rounded corners, thick outline, subtle specular highlight from top-left, soft ambient occlusion, soft inner shadow, gentle drop shadow inside the canvas padding, clean silhouette, fine grain, mobile game UI asset, orthographic front view
~~~
...
## World_Sprites/run_outline_9slice.png (240x240)
- template: GENERIC

**Positive prompt**
~~~
UI element background, creamy plastic toy style, rounded corners, thick outline, soft inner shadow, no text, exact 240x240px, transparent background, centered, no cropping, leave generous transparent padding on all sides (at least ~8% of canvas), ensure the full silhouette and all shadows are fully inside the frame, no element touches the image border, crisp edges, sRGB, PNG, soft 3D plastic UI, creamy warm candy style, rounded corners, thick outline, subtle specular highlight from top-left, soft ambient occlusion, soft inner shadow, gentle drop shadow inside the canvas padding, clean silhouette, fine grain, mobile game UI asset, orthographic front view
~~~
...
## World_Sprites/vfx_complete_burst_sheet_8f_1024x512.png (1024x512)
- template: GENERIC

**Positive prompt**
~~~
UI element background, creamy plastic toy style, rounded corners, thick outline, soft inner shadow, no text, exact 1024x512px, transparent background, centered, no cropping, leave generous transparent padding on all sides (at least ~8% of canvas), ensure the full silhouette and all shadows are fully inside the frame, no element touches the image border, crisp edges, sRGB, PNG, soft 3D plastic UI, creamy warm candy style, rounded corners, thick outline, subtle specular highlight from top-left, soft ambient occlusion, soft inner shadow, gentle drop shadow inside the canvas padding, clean silhouette, fine grain, mobile game UI asset, orthographic front view
~~~
...
## World_Sprites/vfx_complete_burst_sheet_8f_512x256.png (512x256)
- template: GENERIC

**Positive prompt**
~~~
UI element background, creamy plastic toy style, rounded corners, thick outline, soft inner shadow, no text, exact 512x256px, transparent background, centered, no cropping, leave generous transparent padding on all sides (at least ~8% of canvas), ensure the full silhouette and all shadows are fully inside the frame, no element touches the image border, crisp edges, sRGB, PNG, soft 3D plastic UI, creamy warm candy style, rounded corners, thick outline, subtle specular highlight from top-left, soft ambient occlusion, soft inner shadow, gentle drop shadow inside the canvas padding, clean silhouette, fine grain, mobile game UI asset, orthographic front view
~~~
...
## World_Sprites/vfx_confetti_rect_128.png (128x128)
- template: GENERIC

**Positive prompt**
~~~
UI element background, creamy plastic toy style, rounded corners, thick outline, soft inner shadow, no text, exact 128x128px, transparent background, centered, no cropping, leave generous transparent padding on all sides (at least ~8% of canvas), ensure the full silhouette and all shadows are fully inside the frame, no element touches the image border, crisp edges, sRGB, PNG, soft 3D plastic UI, creamy warm candy style, rounded corners, thick outline, subtle specular highlight from top-left, soft ambient occlusion, soft inner shadow, gentle drop shadow inside the canvas padding, clean silhouette, fine grain, mobile game UI asset, orthographic front view
~~~
...
## World_Sprites/vfx_confetti_rect_256.png (256x256)
- template: GENERIC

**Positive prompt**
~~~
UI element background, creamy plastic toy style, rounded corners, thick outline, soft inner shadow, no text, exact 256x256px, transparent background, centered, no cropping, leave generous transparent padding on all sides (at least ~8% of canvas), ensure the full silhouette and all shadows are fully inside the frame, no element touches the image border, crisp edges, sRGB, PNG, soft 3D plastic UI, creamy warm candy style, rounded corners, thick outline, subtle specular highlight from top-left, soft ambient occlusion, soft inner shadow, gentle drop shadow inside the canvas padding, clean silhouette, fine grain, mobile game UI asset, orthographic front view
~~~
...
## World_Sprites/vfx_confetti_star_128.png (128x128)
- template: GENERIC
...
## World_Sprites/vfx_confetti_star_256.png (256x256)
- template: GENERIC
...
## World_Sprites/vfx_confetti_stream_128.png (128x128)
- template: GENERIC
...
## World_Sprites/vfx_confetti_stream_256.png (256x256)
- template: GENERIC
...
## World_Sprites/vfx_confetti_tri_128.png (128x128)
- template: GENERIC
...
## World_Sprites/vfx_confetti_tri_256.png (256x256)
- template: GENERIC
...
## World_Sprites/vfx_firework_confetti_burst_sheet_16f_2048x2048.png (2048x2048)
- template: GENERIC

**Positive prompt**
~~~
UI element background, creamy plastic toy style, rounded corners, thick outline, soft inner shadow, no text, exact 2048x2048px, transparent background, centered, no cropping, leave generous transparent padding on all sides (at least ~8% of canvas), ensure the full silhouette and all shadows are fully inside the frame, no element touches the image border, crisp edges, sRGB, PNG, soft 3D plastic UI, creamy warm candy style, rounded corners, thick outline, subtle specular highlight from top-left, soft ambient occlusion, soft inner shadow, gentle drop shadow inside the canvas padding, clean silhouette, fine grain, mobile game UI asset, orthographic front view
~~~
...
## World_Sprites/vfx_sparkle_star_128.png (128x128)
- template: GENERIC
...
## World_Sprites/vfx_sparkle_star_256.png (256x256)
- template: GENERIC
...
**Positive prompt**
~~~
UI element background, creamy plastic toy style, rounded corners, thick outline, soft inner shadow, no text, exact 256x64px, transparent background, centered, no cropping, leave generous transparent padding on all sides (at least ~8% of canvas), ensure the full silhouette and all shadows are fully inside the frame, no element touches the image border, crisp edges, sRGB, PNG, soft 3D plastic UI, creamy warm candy style, rounded corners, thick outline, subtle specular highlight from top-left, soft ambient occlusion, soft inner shadow, gentle drop shadow inside the canvas padding, clean silhouette, fine grain, mobile game UI asset, orthographic front view
~~~
...
**Positive prompt**
~~~
UI element background, creamy plastic toy style, rounded corners, thick outline, soft inner shadow, no text, exact 512x128px, transparent background, centered, no cropping, leave generous transparent padding on all sides (at least ~8% of canvas), ensure the full silhouette and all shadows are fully inside the frame, no element touches the image border, crisp edges, sRGB, PNG, soft 3D plastic UI, creamy warm candy style, rounded corners, thick outline, subtle specular highlight from top-left, soft ambient occlusion, soft inner shadow, gentle drop shadow inside the canvas padding, clean silhouette, fine grain, mobile game UI asset, orthographic front view
~~~
...
**Positive prompt**
~~~
UI element background, creamy plastic toy style, rounded corners, thick outline, soft inner shadow, no text, exact 1600x891px, transparent background, centered, no cropping, leave generous transparent padding on all sides (at least ~8% of canvas), ensure the full silhouette and all shadows are fully inside the frame, no element touches the image border, crisp edges, sRGB, PNG, soft 3D plastic UI, creamy warm candy style, rounded corners, thick outline, subtle specular highlight from top-left, soft ambient occlusion, soft inner shadow, gentle drop shadow inside the canvas padding, clean silhouette, fine grain, mobile game UI asset, orthographic front view
~~~
...
**Positive prompt**
~~~
UI element background, creamy plastic toy style, rounded corners, thick outline, soft inner shadow, no text, exact 1556x266px, transparent background, centered, no cropping, leave generous transparent padding on all sides (at least ~8% of canvas), ensure the full silhouette and all shadows are fully inside the frame, no element touches the image border, crisp edges, sRGB, PNG, soft 3D plastic UI, creamy warm candy style, rounded corners, thick outline, subtle specular highlight from top-left, soft ambient occlusion, soft inner shadow, gentle drop shadow inside the canvas padding, clean silhouette, fine grain, mobile game UI asset, orthographic front view
~~~
...
**Positive prompt**
~~~
UI element background, creamy plastic toy style, rounded corners, thick outline, soft inner shadow, no text, exact 370x235px, transparent background, centered, no cropping, leave generous transparent padding on all sides (at least ~8% of canvas), ensure the full silhouette and all shadows are fully inside the frame, no element touches the image border, crisp edges, sRGB, PNG, soft 3D plastic UI, creamy warm candy style, rounded corners, thick outline, subtle specular highlight from top-left, soft ambient occlusion, soft inner shadow, gentle drop shadow inside the canvas padding, clean silhouette, fine grain, mobile game UI asset, orthographic front view
~~~
...
**Positive prompt**
~~~
UI element background, creamy plastic toy style, rounded corners, thick outline, soft inner shadow, no text, exact 110x108px, transparent background, centered, no cropping, leave generous transparent padding on all sides (at least ~8% of canvas), ensure the full silhouette and all shadows are fully inside the frame, no element touches the image border, crisp edges, sRGB, PNG, soft 3D plastic UI, creamy warm candy style, rounded corners, thick outline, subtle specular highlight from top-left, soft ambient occlusion, soft inner shadow, gentle drop shadow inside the canvas padding, clean silhouette, fine grain, mobile game UI asset, orthographic front view
~~~
...
**Positive prompt**
~~~
UI element background, creamy plastic toy style, rounded corners, thick outline, soft inner shadow, no text, exact 380x235px, transparent background, centered, no cropping, leave generous transparent padding on all sides (at least ~8% of canvas), ensure the full silhouette and all shadows are fully inside the frame, no element touches the image border, crisp edges, sRGB, PNG, soft 3D plastic UI, creamy warm candy style, rounded corners, thick outline, subtle specular highlight from top-left, soft ambient occlusion, soft inner shadow, gentle drop shadow inside the canvas padding, clean silhouette, fine grain, mobile game UI asset, orthographic front view
~~~
...
**Positive prompt**
~~~
UI element background, creamy plastic toy style, rounded corners, thick outline, soft inner shadow, no text, exact 880x330px, transparent background, centered, no cropping, leave generous transparent padding on all sides (at least ~8% of canvas), ensure the full silhouette and all shadows are fully inside the frame, no element touches the image border, crisp edges, sRGB, PNG, soft 3D plastic UI, creamy warm candy style, rounded corners, thick outline, subtle specular highlight from top-left, soft ambient occlusion, soft inner shadow, gentle drop shadow inside the canvas padding, clean silhouette, fine grain, mobile game UI asset, orthographic front view
~~~
...
**Positive prompt**
~~~
UI icon glyph of booster shuffle, bold rounded silhouette, warm white fill, thick dark brown outline, subtle highlight and micro-shadow, clean silhouette, no text, exact 424x410px, transparent background, centered, no cropping, leave generous transparent padding on all sides (at least ~8% of canvas), ensure the full silhouette and all shadows are fully inside the frame, no element touches the image border, crisp edges, sRGB, PNG, soft 3D plastic UI, creamy warm candy style, rounded corners, thick outline, subtle specular highlight from top-left, soft ambient occlusion, soft inner shadow, gentle drop shadow inside the canvas padding, clean silhouette, fine grain, mobile game UI asset, orthographic front view
~~~
...
**Positive prompt**
~~~
UI icon glyph of coin, bold rounded silhouette, warm white fill, thick dark brown outline, subtle highlight and micro-shadow, clean silhouette, no text, exact 332x194px, transparent background, centered, no cropping, leave generous transparent padding on all sides (at least ~8% of canvas), ensure the full silhouette and all shadows are fully inside the frame, no element touches the image border, crisp edges, sRGB, PNG, soft 3D plastic UI, creamy warm candy style, rounded corners, thick outline, subtle specular highlight from top-left, soft ambient occlusion, soft inner shadow, gentle drop shadow inside the canvas padding, clean silhouette, fine grain, mobile game UI asset, orthographic front view
~~~
...
## BoosterPurchase/popup_shuffle_full.png (930x1332)
- template: GENERIC

**Positive prompt**
~~~
UI element background, creamy plastic toy style, rounded corners, thick outline, soft inner shadow, no text, exact 930x1332px, transparent background, centered, no cropping, leave generous transparent padding on all sides (at least ~8% of canvas), ensure the full silhouette and all shadows are fully inside the frame, no element touches the image border, crisp edges, sRGB, PNG, soft 3D plastic UI, creamy warm candy style, rounded corners, thick outline, subtle specular highlight from top-left, soft ambient occlusion, soft inner shadow, gentle drop shadow inside the canvas padding, clean silhouette, fine grain, mobile game UI asset, orthographic front view
~~~
...
## BoosterPurchase/popup_sort_full.png (994x1427)
- template: GENERIC

**Positive prompt**
~~~
UI element background, creamy plastic toy style, rounded corners, thick outline, soft inner shadow, no text, exact 994x1427px, transparent background, centered, no cropping, leave generous transparent padding on all sides (at least ~8% of canvas), ensure the full silhouette and all shadows are fully inside the frame, no element touches the image border, crisp edges, sRGB, PNG, soft 3D plastic UI, creamy warm candy style, rounded corners, thick outline, subtle specular highlight from top-left, soft ambient occlusion, soft inner shadow, gentle drop shadow inside the canvas padding, clean silhouette, fine grain, mobile game UI asset, orthographic front view
~~~
...
**Positive prompt**
~~~
UI element background, creamy plastic toy style, rounded corners, thick outline, soft inner shadow, no text, exact 143x144px, transparent background, centered, no cropping, leave generous transparent padding on all sides (at least ~8% of canvas), ensure the full silhouette and all shadows are fully inside the frame, no element touches the image border, crisp edges, sRGB, PNG, soft 3D plastic UI, creamy warm candy style, rounded corners, thick outline, subtle specular highlight from top-left, soft ambient occlusion, soft inner shadow, gentle drop shadow inside the canvas padding, clean silhouette, fine grain, mobile game UI asset, orthographic front view
~~~
...
**Positive prompt**
~~~
UI element background, creamy plastic toy style, rounded corners, thick outline, soft inner shadow, no text, exact 632x244px, transparent background, centered, no cropping, leave generous transparent padding on all sides (at least ~8% of canvas), ensure the full silhouette and all shadows are fully inside the frame, no element touches the image border, crisp edges, sRGB, PNG, soft 3D plastic UI, creamy warm candy style, rounded corners, thick outline, subtle specular highlight from top-left, soft ambient occlusion, soft inner shadow, gentle drop shadow inside the canvas padding, clean silhouette, fine grain, mobile game UI asset, orthographic front view
~~~
...
**Positive prompt**
~~~
toggle UI component part, creamy plastic toy style, rounded beveled edges, thick outline, soft inner shadow, no text, exact 221x132px, transparent background, centered, no cropping, leave generous transparent padding on all sides (at least ~8% of canvas), ensure the full silhouette and all shadows are fully inside the frame, no element touches the image border, crisp edges, sRGB, PNG, soft 3D plastic UI, creamy warm candy style, rounded corners, thick outline, subtle specular highlight from top-left, soft ambient occlusion, soft inner shadow, gentle drop shadow inside the canvas padding, clean silhouette, fine grain, mobile game UI asset, orthographic front view
~~~
...
**Positive prompt**
~~~
UI element background, creamy plastic toy style, rounded corners, thick outline, soft inner shadow, no text, exact 902x1233px, transparent background, centered, no cropping, leave generous transparent padding on all sides (at least ~8% of canvas), ensure the full silhouette and all shadows are fully inside the frame, no element touches the image border, crisp edges, sRGB, PNG, soft 3D plastic UI, creamy warm candy style, rounded corners, thick outline, subtle specular highlight from top-left, soft ambient occlusion, soft inner shadow, gentle drop shadow inside the canvas padding, clean silhouette, fine grain, mobile game UI asset, orthographic front view
~~~
