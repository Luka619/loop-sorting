...
- 9-slice 规则：给出 pattern + border（参考 `../../Assets/Resources/loop_sorting_ui_components_v04_4_meta_pack_firework_confetti/Docs/UI_GUIDE.md`）
...
- 文本：TMP 必须有 Outline + Underlay（参数参考 `../../Assets/Resources/loop_sorting_ui_components_v04_4_meta_pack_firework_confetti/Docs/UI_GUIDE.md`）
